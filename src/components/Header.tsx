  ...
  return (
    <header className="hero-header">
      ...
      <div className="hero-social-row">
        ...
        <a href="https://www.linkedin.com/in/ninaddaithankar/" aria-label="LinkedIn" className="hero-social-icon" target="_blank" rel="noopener noreferrer"><i className="fa-brands fa-linkedin-in"></i></a>
        
        <a href="https://wandb.ai/profile/ninaddaithankar" aria-label="WandB" className="hero-social-icon" target="_blank" rel="noopener noreferrer"><i className="fa-solid fa-wand-magic-sparkles"></i></a>
